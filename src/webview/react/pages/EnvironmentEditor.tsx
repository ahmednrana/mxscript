...
export const EnvironmentEditor: React.FC<EnvironmentEditorProps> = ({
  ...
  // Stable helper to validate against an explicit snapshot of state to avoid
  ...
  const validateField = useCallback((meta: SettingMeta, value: any, state?: FormState): string | undefined => validateFieldWithState(meta, value, state ?? form), [form, validateFieldWithState]);
