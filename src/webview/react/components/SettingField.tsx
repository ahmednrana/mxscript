...
/**
 * SettingField
 * Renders a complete, state-aware form field for a single setting. It determines
 * which UI control to use based on the setting's metadata and wires up all the
 * necessary state and event handlers. It uses the presentational `SettingItem`
 * component for the row layout.
 */
