...
exports.MaximoEnvironmentTreeProvider = exports.MaximoEnvironmentTreeItem = void 0;
const vscode = require("vscode");
/**
 * TreeItem representing a Maximo environment
 */
class MaximoEnvironmentTreeItem extends vscode.TreeItem {
    constructor(environment, isActive) {
...
exports.MaximoEnvironmentTreeItem = MaximoEnvironmentTreeItem;
/**
 * TreeView provider for Maximo environments
 */
class MaximoEnvironmentTreeProvider {
    ...
    getChildren(element) {
        ...
        const globalEnvs = this._context.globalState.get('mxscript.environments', []);
        const workspaceEnvs = this._context.workspaceState.get('mxscript.environments', []);
        const environments = [...globalEnvs, ...workspaceEnvs];
        // Get active environment
        const activeEnvId = this._context.globalState.get('mxscript.activeEnvironment');
        // Create tree items for each environment
        const items = environments.map(env => new MaximoEnvironmentTreeItem(env, env.id === activeEnvId));
...
exports.MaximoEnvironmentTreeProvider = MaximoEnvironmentTreeProvider;
//# sourceMappingURL=MaximoEnvironmentTreeProvider.js.map